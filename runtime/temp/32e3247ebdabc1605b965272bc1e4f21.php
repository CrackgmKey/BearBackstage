<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"D:\phpStudy\WWW\yg/apps/admin\view\qiniu\index.tpl";i:1530198463;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1508850092;}*/ ?>
...
$(document).ready(function(){
	...
	$("#back").click(function(){
		window.location.href="<?php echo url('admin/qiniu/index'); ?>";
	})
	
	$("#mod").click(function(){
		$("#form1").attr("action","<?php echo url('admin/qiniu/mod'); ?>");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	...
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;系统管理&nbsp;>&nbsp;七牛云设置</div>
	<div class="tab-box">
		<ul>
	...
	<div class="add-box">
		<ul>
			<li><div class="title">ACCESSKEY</div><div class="input-box"><input name="ACCESSKEY" type="text" class="input" value="<?php echo $data['ACCESSKEY']; ?>"/></div><div class="clear"></div></li>
			<li><div class="title">SECRETKEY</div><div class="input-box"><input name="SECRETKEY" type="text" class="input" value="<?php echo $data['SECRETKEY']; ?>"/></div><div class="clear"></div></li>
			<li><div class="title">空间</div><div class="input-box"><input name="BUCKET" type="text" class="input" value="<?php echo $data['BUCKET']; ?>"/></div><div class="clear"></div></li>
			<li><div class="title">绑定域名</div><div class="input-box"><input name="DOMAIN" type="text" class="input" value="<?php echo $data['DOMAIN']; ?>"/></div><div class="clear"></div></li>
		</ul>
	</div>
