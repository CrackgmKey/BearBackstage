<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"D:\phpStudy\WWW\yg/apps/admin\view/public/dispatch.tpl";i:1498635756;}*/ ?>
<html>
	<head>
	...
	<body>
    	<div id="notice">
            ...
            <div class="content">
            	<div class="sign"  <?php if($code){ ?>style="background:url(/yg/public/static/admin/images/error_success.png) -250px 0px no-repeat;"  <?php } else { ?>style="background:url(/yg/public/static/admin/images/error_success.png) no-repeat;" <?php } ?>></div>
                <div class="mess">
