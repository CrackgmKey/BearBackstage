<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"D:\phpStudy\WWW\yg/apps/admin\view\link\index.tpl";i:1530283471;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1550568981;}*/ ?>
...
$(document).ready(function(){
	...
	$("#update").click(function(){
		$("#form1").attr("action","<?php echo url('admin/link/batchSort'); ?>");
		$("#form1").submit();
	})
	...
	$("#dels").click(function(){
		...
		layui.use(['layer', 'form'], function(){
			layer.confirm('你确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			 $("#form1").attr("action","<?php echo url('admin/link/del'); ?>");
			 $("#form1").submit();
			  layer.close(index);
			});
		});
	...
	$("#add").click(function(){
		window.location.href="<?php echo url('admin/link/add'); ?>";
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;内容管理&nbsp;>&nbsp;友情链接</div>
	<div class="list-box">
		<div class="title">
			<ul>
				...
				<ul>
					...
					<li style="width:45%;position:relative;z-index:900">
						<div class="left" title="<?php echo $data['name']; ?>">
							<span class="green">[点击:<?php echo $data['click']; ?>]</span>&nbsp<?php if($data['img']): ?><span  class="green thumb"  style="cursor:pointer;" url="<?php echo $data['img']; ?>">[有图]</span><?php else: ?><span class="red">[无图]</span><?php endif; ?>&nbsp;<?php echo $data['name']; ?>
						</div>
						<?php if($data['img']): ?><div class="thumb-box"><img src="<?php echo $data['img']; ?>"></div><?php endif; ?>
					</li>
