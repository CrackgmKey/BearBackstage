<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"D:\phpStudy\WWW\yg/apps/admin\view\group\index.tpl";i:1511701782;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1550568981;}*/ ?>
...
$(document).ready(function(){
	...
	$(".default").click(function(){
		...
		var url="<?php echo url('admin/group/changeDefault'); ?>";
		var id=$(this).attr("id");
		var obj=$(this);
	...
	$("#update").click(function(){
		$("#form1").attr("action","<?php echo url('admin/group/batchSort'); ?>");
		$("#form1").submit();
	})
	...
	$("#dels").click(function(){
		layui.use(['layer', 'form'], function(){
			layer.confirm('你确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			 $("#form1").attr("action","<?php echo url('admin/group/del'); ?>");
			 $("#form1").submit();
			  layer.close(index);
			});
		});
	...
	$("#add").click(function(){
		window.location.href="<?php echo url('admin/group/add'); ?>";
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;用户管理&nbsp;>&nbsp;用户分组</div>
	<div class="list-box">
		<div class="title">
			<ul>
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:15%"><?php if(!$data['is_sub']): ?><div class="default_<?php echo $data['is_default']; ?> default" id="<?php echo $data['id']; ?>" ></div><?php endif; ?></li>
				...
				<div class="sub sub_<?php echo $data['id']; ?>">
					<?php if(is_array($data['sub']) || $data['sub'] instanceof \think\Collection || $data['sub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?>
						<ul >
							...
							<li style="width:15%"><div class="default_<?php echo $d['is_default']; ?> default" id="<?php echo $d['id']; ?>" ></div></li>
							<li style="width:10%;"><?php echo $d['score']; ?></li>
