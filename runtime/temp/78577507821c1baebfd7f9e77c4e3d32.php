<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"D:\phpStudy\WWW\yg/apps/admin\view\mails\test.tpl";i:1500301676;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1508850092;}*/ ?>
...
$(document).ready(function(){
	...
	$(".radio-box1 .radio").click(function(){
	 ...
	 $("#send").click(function () {
		...
		$(".loading").show();
		$("#form1").attr("action","<?php echo url('admin/mails/test'); ?>");
		$("#form1").submit();
	});
...
<div class="main" id="main">
	...
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;系统管理&nbsp;>&nbsp;测试邮件</div>
	<div class="tab-box">
		<ul>
