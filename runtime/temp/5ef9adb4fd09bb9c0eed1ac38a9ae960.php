<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"D:\phpStudy\WWW\yg/apps/admin\view\pcate\index.tpl";i:1511703854;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1550568981;}*/ ?>
...
$(document).ready(function(){
	...
	$("#update").click(function(){
		$("#form1").attr("action","<?php echo url('admin/pcate/batchSort'); ?>");
		$("#form1").submit();
	})
	...
	$("#dels").click(function(){
		...
		layui.use(['layer', 'form'], function(){
			layer.confirm('你确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			 $("#form1").attr("action","<?php echo url('admin/pcate/del'); ?>");
			 $("#form1").submit();
			  layer.close(index);
			});
		});
	...
	$("#add").click(function(){
		window.location.href="<?php echo url('admin/pcate/add'); ?>";
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;内容管理&nbsp;>&nbsp;单页管理</div>
	<div class="list-box">
		<div class="title">
			<ul>
				<li style="width:10%">&nbsp;&nbsp;<input type="checkbox" id="all_select" class="check-style" ></li>
				<li style="width:10%">编号</li>
				<li style="width:45%">导航名称</li>
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:45%"><div class="left" style="width:100px;"><?php echo $data['name']; ?></div></li>
