<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"D:\phpStudy\WWW\yg/apps/admin\view\nav\index.tpl";i:1511703178;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1550568981;}*/ ?>
...
$(document).ready(function(){
	...
	$(".display").click(function(){
		...
		var url="<?php echo url('admin/nav/changeDisplay'); ?>";
		var id=$(this).attr("id");
		var obj=$(this);
	...
	$("#update").click(function(){
		$("#form1").attr("action","<?php echo url('admin/nav/batchSort'); ?>");
		$("#form1").submit();
	})
	...
	$("#dels").click(function(){
		...
		layui.use(['layer', 'form'], function(){
			layer.confirm('你确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			 $("#form1").attr("action","<?php echo url('admin/nav/del'); ?>");
			 $("#form1").submit();
			  layer.close(index);
			});
		});
	...
	$("#add").click(function(){
		window.location.href="<?php echo url('admin/nav/add'); ?>";
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;内容管理&nbsp;>&nbsp;分类导航</div>
	<div class="list-box">
		<div class="title">
			<ul>
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:30%"><div class="left" style="width:100px;"><?php echo $data['name']; ?></div><?php if($data['is_sub']): ?><div class="up-icon slide" id="<?php echo $data['id']; ?>" title="下拉子导航"></div><?php endif; ?></li>
					<li style="width:15%;"><input type="text" name="sort[<?php echo $data['id']; ?>]" value="<?php echo $data['sort']; ?>" class="input" maxlength="3"></li>
					<li style="width:15%"><div class="display_<?php echo $data['display']; ?> display" id="<?php echo $data['id']; ?>" ></div></li>
				...
				<div class="sub sub_<?php echo $data['id']; ?>">
					<?php if(is_array($data['sub']) || $data['sub'] instanceof \think\Collection || $data['sub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?>
						<ul >
							...
							<li style="width:30%;"><div class="ntree-icon"></div><div class="left name"><?php echo $d['name']; ?></div></li>
							<li style="width:15%;"><input type="text" name="sort[<?php echo $d['id']; ?>]" value="<?php echo $d['sort']; ?>" class="input_sub" maxlength="3"></li>
							<li style="width:15%"><div class="display_<?php echo $d['display']; ?> display" id="<?php echo $d['id']; ?>" ></div></li>
							<li style="width:20%"><div class="mod-icon mod" url="<?php echo $d['mod_url']; ?>" >编</div><div class="del-icon del" url="<?php echo $d['del_url']; ?>">删</div><div class="clear"></div></li>
							<div class="clear"></div>
					</a>
					</ul>
