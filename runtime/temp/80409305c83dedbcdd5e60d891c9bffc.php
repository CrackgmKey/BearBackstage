<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\phpStudy\WWW\yg/apps/admin\view\logs\adminactlog.tpl";i:1511704020;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1550568981;}*/ ?>
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;日志管理&nbsp;>&nbsp;管理员操作日志</div>
	<div class="list-box">
		<div class="title">
			<ul>
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:15%"><?php echo $data['adm_name']; ?></li>
					<li style="width:40%;"><span class="green"><?php echo $data['act_name']; ?></span></li>
					<li style="width:15%;"><?php echo $data['act_time']; ?></li>
					<li style="width:10%"><div class="del-icon del" url="<?php echo $data['del_url']; ?>" >删</div><div class="clear"></div></li>
					<div class="clear"></div>
					</a>
