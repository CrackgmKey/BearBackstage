<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"D:\phpStudy\WWW\yg/apps/admin\view\acate\add.tpl";i:1502460314;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1550568981;}*/ ?>
...
$(document).ready(function(){
	...
	$("#add").click(function(){
		$("#form1").attr("action","<?php echo url('admin/acate/add'); ?>");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	...
	<div class="add-box">
		<ul>
			<li><div class="title">分类名称</div><div class="input-box"><input name="name" type="text" class="input"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li><div class="title">分类排序</div><div class="input-box"><input name="sort" type="text" class="input" value="<?php echo $maxsort; ?>"/></div><div class="tip">*</div><div class="clear"></div></li>
