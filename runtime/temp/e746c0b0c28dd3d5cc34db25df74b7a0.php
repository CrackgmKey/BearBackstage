<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"D:\phpStudy\WWW\yg/apps/admin\view\logs\userlog.tpl";i:1526614196;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1550568981;}*/ ?>
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;日志管理&nbsp;>&nbsp;会员登陆日志</div>
	<div class="list-box">
		<div class="title">
			<ul>
				<li style="width:10%">&nbsp;&nbsp;<input type="checkbox" id="all_select" class="check-style" ></li>
				<li style="width:10%">编号</li>
				<li style="width:35%">会员名称</li>
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:35%"><?php echo $data['user_name']; ?></li>
