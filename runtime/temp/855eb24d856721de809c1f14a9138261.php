<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\phpStudy\WWW\yg/apps/admin\view\admingroup\index.tpl";i:1511698924;s:48:"D:\phpStudy\WWW\yg\apps\admin\view\index\top.tpl";i:1508850092;}*/ ?>
...
$(document).ready(function(){
	...
	$("#dels").click(function(){
		...
		layui.use(['layer', 'form'], function(){
			layer.confirm('你确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			 $("#form1").attr("action","<?php echo url('admin/admingroup/del'); ?>");
			 $("#form1").submit();
			  layer.close(index);
			});
		});
	...
	$("#add").click(function(){
		window.location.href="<?php echo url('admin/admingroup/add'); ?>";
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="<?php echo url('admin/index/index'); ?>" target="_top">首页</a>&nbsp;>&nbsp;系统管理&nbsp;>&nbsp;管理员设置</div>
	<div class="tab-box">
		<ul>
			<li class="cur">管理员分组</li>
			<li><a href="<?php echo url('admin/admin/index'); ?>">管理员列表</a></li>
		</ul>
	</div>
	<div class="list-box">
		<div class="title">
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:60%"><div class="left" style="width:100px;"><?php echo $data['name']; ?></div></li>
