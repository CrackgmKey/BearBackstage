<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"D:\phpStudy\WWW\yg/apps/admin\view\index\left.tpl";i:1550569308;}*/ ?>
...
<link href="/yg/public/static/admin/css/left.css" rel="stylesheet" type="text/css" />
...
<div class="brief">
	<div class="box" style="margin:0 auto;">
		<div class="avatar">
			<div class="mask"><img src="/yg/public/static/admin/images/avatar-bg.png"></div>
			<div class="avatar-img">
			<?php if($adm_avatar): ?>
				<img src="/yg/public/uploads/<?php echo $adm_avatar; ?>">
			<?php else: ?>
				<img src="/yg/public/static/admin/images/user-default.jpg">
			<?php endif; ?>
			</div>
		</div>
		<div class="uname u1"><?php echo $adm_name; ?></div>
		<div class="uname u2"><?php echo $group_cn; ?></div>
		<div class="clear"></div>
	</div>
</div>
...
<div class="nav" id="nav">
	<ul>
		...
		<div class="sub-nav s1">
			<span><a href="<?php echo url('admin/nav/index'); ?>" target="main">分类导航</a></span>
			<span><a href="<?php echo url('admin/news/index'); ?>" target="main">新闻管理</a></span>
			<span  class="last"><a href="<?php echo url('admin/acate/index'); ?>" target="main">广告管理</a></span>
		</div>
	...
	<div class="sub-nav s4">
			<span><a href="<?php echo url('admin/user/index'); ?>" target="main">会员用户</a></span>
			<span><a href="<?php echo url('admin/hotword/index'); ?>" target="main">搜索热词</a></span>
			<span class="last"><a href="<?php echo url('admin/lottery/index'); ?>" target="main">积分抽奖</a></span>
		</div>
	...
	<div class="sub-nav s3">
			<span><a href="<?php echo url('admin/logs/index',array('type'=>1)); ?>" target="main">会员登陆</a></span>
			<span><a href="<?php echo url('admin/logs/index',array('type'=>2)); ?>" target="main">管理员登陆</a></span>
			<span  class="last"><a href="<?php echo url('admin/logs/index',array('type'=>3)); ?>" target="main">管理员操作</a></span>
	...
	<ul>
		...
		<div class="sub-nav s6">
			<span class="last"><a href="<?php echo url('admin/configs/index',array('id'=>1)); ?>" target="main">网站设置</a></span>
