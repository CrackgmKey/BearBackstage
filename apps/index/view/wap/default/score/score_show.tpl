...
<section>
	...
	<div class="pinfo">
		<div class="price">{$proData.symbol}:<span id="price">{$proData.current_price}</span></div>
		<div class="price_o" id="origin_price">{$proData.symbol}:{$proData.origin_price}</div>
		<div class="clear"></div>
	</div>
	<div class="pinfo" style="height:4.5rem;">
		
		<div class="addfav pbut" id="addfav">收藏</div>
		<div class="buy pbut" id="settlement">兑换</div>
