	...
	$(".settlement").click(
		function(){
			if(!uid){
				...
				var url="{Leesun:url name='addScoreCart' /}";
				var p_num=$("#p_num").val();
				var inventory=$("#inventory").attr("data");
				if(!inventory){
				...
				$.ajax({   
					type:"post",     
					url:url,
					data:{pid:pid,uid:uid,amount:p_num,score:price},
					success:function(msg){
						window.location.href="{Leesun:url name='scoreCart' /}";
					},   
					error:function(){
						layui.use(['layer'], function(){
...
<div class="web_body">
	<div class="left">
		...
		<div class="box">
			<div class="rec-box">
				...
				<div class="con">
					<ul>
					{Leesun:product name='v'  num='6' recommend='1' type='4' sort='add_time desc'}
					<li>
						<div class="img"><a href="{$v.url}">{if condition="$v.thumb"}<img src="__ROOT____UPLOADS__/{$v.thumb}" id="img_{$v.id}" width='185' height='141' >{else}<img src="__ROOT____INDEX__/images/no-pic.jpg"  class="img"/>{/if}</a></div>
	...
	<div class="left" style="margin-left:12px;">
		<div class="box">
			<div class="show-box">
				<div class="img-box">
					<div class="main jqzoom" ><img src="__ROOT____UPLOADS__/{$proData.img}" class="main-img" id="main_img" jqimg="__ROOT____UPLOADS__/{$proData.img}" ></div>
					<div class="clear"></div>
					<div class="scroll-box">
						...
						<div class="imgs-box" id="imgs-box">
							<div class="imgs" id="imgs">
								<ul>
									<li><img src="__ROOT____UPLOADS__/{$proData.img}" id="simg"  class="img" width="91" height="70"></li>
									
									{volist name="proData['spec']" id="v"}
									<li><img src="__ROOT____UPLOADS__/{$v.img}" id="simg_{$v.id}"  class="img" width="91" height="70"></li>
									{/volist}
								</ul>
							</div>
						</div>
				...
				<div class="info-box">
					...
					<div class="price-box">
						<h5>原需{$proData.symbol}：<span class="s" id="origin_price">{$proData.origin_price}</span></h5>
						<h1>先需{$proData.symbol}：<span class="s" id="current_price"><span id="price">{$proData.current_price}</span></span></h1>
