	...
	<div class="right">
		<div class="box">
			<div class="banner">
				...
				<a target="_blank" href="{$v.url}"><img  src="{$v.pic}" class="img" ></a>
				{/Leesun:adv}
			</div>
		</div>
				...
				<div class="list">
					<ul>
						...
						<li>
							...
							<div class="price"><span class="red">&yen;{$pv.origin_price}</span>&nbsp;&nbsp;&nbsp;<span class="grey" style="text-decoration:line-through">&yen;{$pv.current_price}</span></div>
						</li>
						{/Leesun:product}
						<div class="clear"></div>
					</ul>
