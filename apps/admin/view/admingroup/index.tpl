...
$(document).ready(function(){
	...
	$("#dels").click(function(){
		...
		layui.use(['layer', 'form'], function(){
			layer.confirm('你确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			 $("#form1").attr("action","{:url('admin/admingroup/del')}");
			 $("#form1").submit();
			  layer.close(index);
			});
		});
	...
	$("#add").click(function(){
		window.location.href="{:url('admin/admingroup/add')}";
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;系统管理&nbsp;>&nbsp;管理员设置</div>
	<div class="tab-box">
		<ul>
			<li class="cur">管理员分组</li>
	...
	<div class="list-box">
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:60%"><div class="left" style="width:100px;">{$data.name}</div></li>
