...
$(document).ready(function(){
	...
	$("#add").click(function(){
		$("#form1").attr("action","{:url('admin/hotword/add')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;用户管理&nbsp;>&nbsp;添加搜索热词</div>
	
	<div class="add-box">
		<ul>
			<li><div class="title">关键字名称</div><div class="input-box"><input name="keyword" type="text" class="input" value=""/></div><div class="tip">*</div><div class="clear"></div></li>
			<li>
