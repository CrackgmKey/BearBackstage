...
$(document).ready(function(){
	...
	$(".radio-box1 .radio").click(function(){
	 ...
	 $("#send").click(function () {
		...
		$(".loading").show();
		$("#form1").attr("action","{:url('admin/sms/test')}");
		$("#form1").submit();
	});
...
<div class="main" id="main">
	...
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;系统管理&nbsp;>&nbsp;测试短信</div>
	<div class="tab-box">
		<ul>
			<li><a href="{:url('admin/sms/index')}">阿里大鱼服务商</a></li>
			<li class="cur">测试短信</li>
	...
	<div class="add-box">
		<ul>
			<li><div class="title">手机号</div><div class="input-box"><input name="mobile" type="text" class="input" value=""/></div><div class="clear"></div></li>
		</ul>
	</div>
