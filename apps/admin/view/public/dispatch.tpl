<html>
	...
	<body>
    	<div id="notice">
            ...
            <div class="content">
            	<div class="sign"  <?php if($code){ ?>style="background:url(__ROOT____ADMIN__/images/error_success.png) -250px 0px no-repeat;"  <?php } else { ?>style="background:url(__ROOT____ADMIN__/images/error_success.png) no-repeat;" <?php } ?>></div>
                <div class="mess">
