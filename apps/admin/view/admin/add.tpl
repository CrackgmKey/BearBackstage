...
$(document).ready(function(){
	...
	$("#add").click(function(){
		$("#form1").attr("action","{:url('admin/admin/add')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;系统管理&nbsp;>&nbsp;添加管理员</div>
	
	<div class="add-box">
		<ul>
			<li><div class="title">管理员名称</div><div class="input-box"><input name="adm_name" type="text" class="input"/></div><div class="tip">*</div><div class="clear"></div></li>
			...
			<li><div class="title">管理员密码</div><div class="input-box"><input name="adm_password" type="password" class="input"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li><div class="title">确认密码</div><div class="input-box"><input name="password_confirm" type="password" class="input"/></div><div class="tip">*</div><div class="clear"></div></li>
