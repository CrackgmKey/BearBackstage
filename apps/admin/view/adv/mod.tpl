...
$(document).ready(function(){
	...
	$("#mod").click(function(){
		...
		$(".loading").show();
		$("#form1").attr("action","{:url('admin/adv/mod')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;内容管理&nbsp;>&nbsp;商品轮播</div>
	...
	<div class="add-box">
		<ul>
			...
			<li>
				...
				<div class="img-path" id="img-path"><img src="{$data.pic}"></div>
				<div class="clear"></div>
			</li>
			<li><div class="title">商品ID</div><div class="input-box"><input name="url" type="text" class="input" value="{$data.url}"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li><div class="title">轮播排序</div><div class="input-box"><input name="sort" type="text" class="input" value="{$data.sort}"/></div><div class="tip">*</div><div class="clear"></div></li>
