...
$(document).ready(function(){
	...
	$("#add").click(function(){
		$("#form1").attr("action","{:url('admin/pcate/add')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;内容管理&nbsp;>&nbsp;添加单页</div>
	
	<div class="add-box">
		<ul>
			<li><div class="title">单页名称</div><div class="input-box"><input name="name" type="text" class="input"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li class="textarea"><div class="title">单页内容</div><div class="textarea-box" ><textarea name="content" id="content" cols="80" rows="5" style="width:800px;height:370px;"></textarea></div><div class="tip">*</div><div class="clear"></div></li>
			<li><div class="title">单页排序</div><div class="input-box"><input name="sort" type="text" class="input" value="{$maxsort}"/></div><div class="tip">*</div><div class="clear"></div></li>
