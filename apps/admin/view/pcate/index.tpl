...
$(document).ready(function(){
	...
	$("#update").click(function(){
		$("#form1").attr("action","{:url('admin/pcate/batchSort')}");
		$("#form1").submit();
	})
	...
	$("#dels").click(function(){
		...
		layui.use(['layer', 'form'], function(){
			layer.confirm('你确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			 $("#form1").attr("action","{:url('admin/pcate/del')}");
			 $("#form1").submit();
			  layer.close(index);
			});
		});
	...
	$("#add").click(function(){
		window.location.href="{:url('admin/pcate/add')}";
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;内容管理&nbsp;>&nbsp;单页管理</div>
	<div class="list-box">
		<div class="title">
			<ul>
		...
		<div class="list" id="list">
				...
				<ul>
					...
					<li style="width:45%"><div class="left" style="width:100px;">{$data.name}</div></li>
