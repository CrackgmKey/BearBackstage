...
$(document).ready(function(){
	...
	$("#mod").click(function(){
		$("#form1").attr("action","{:url('admin/lottery/mod')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/lottery/index')}" target="_top">首页</a>&nbsp;>&nbsp;用户管理&nbsp;>&nbsp;编辑积分抽奖</div>
	
	<div class="add-box">
		<ul>
			<li><div class="title">抽奖名称</div><div class="input-box"><input name="name" type="text" class="input" value="{$data.name}"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li><div class="title">奖品数量</div><div class="input-box"><input name="total" type="text" class="input" value="{$data.total}"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li>
				<div class="title">抽奖类型</div>
				<div class="input-box-s" style="z-index:100"><span class="select-title">{$data.category_cn}</span>
