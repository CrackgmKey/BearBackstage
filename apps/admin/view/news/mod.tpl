...
$(document).ready(function(){
	...
	$("#mod").click(function(){
		...
		$(".loading").show();
		$("#form1").attr("action","{:url('admin/news/mod')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;内容管理&nbsp;>&nbsp;编辑新闻</div>
	<div class="loading">乐尚商城提示您，请稍候！</div>
	<div class="add-box">
		<ul>
			<li><div class="title">文章标题</div><div class="input-box"><input name="title" type="text" class="input" value="{$data.title}"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li>
				<div class="title">所属栏目</div>
				<div class="input-box-s" style="z-index:1000"><span class="select-title">{$data.cate_cn}</span>
			...
			<li class="textarea" ><div class="title">文章内容</div><div class="textarea-box" ><textarea name="content" id="content" style="width:800px;height:390px;">{$data.content}</textarea></div><div class="clear"></div></li>

			<li><div class="title">文章排序</div><div class="input-box"><input name="sort" type="text" class="input" value="{$data.sort}"/></div><div class="tip">*</div><div class="clear"></div></li>
