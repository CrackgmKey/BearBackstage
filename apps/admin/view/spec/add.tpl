...
$(document).ready(function(){
	...
	$("#add").click(function(){
		$("#form1").attr("action","{:url('admin/spec/add')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;商品管理&nbsp;>&nbsp;添加规格</div>
	
	<div class="add-box">
		<ul>
			<li><div class="title">规格名称</div><div class="input-box"><input name="name" type="text" class="input"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li>
				<div class="title">所属栏目</div>
				<div class="input-box-s" style="z-index:101"><span class="select-title">选择栏目</span>
