...
$(document).ready(function(){
	...
	$("#mod").click(function(){
		$("#form1").attr("action","{:url('admin/group/mod')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	...
	<div class="add-box">
		<ul>
			<li><div class="title">分组名称</div><div class="input-box"><input name="name" type="text" class="input" value="{$data.name}"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li>
			...
			<li><div class="title">分组积分</div><div class="input-box"><input name="score" type="text" class="input"  value="{$data.score}" /></div><div class="clear"></div></li>
