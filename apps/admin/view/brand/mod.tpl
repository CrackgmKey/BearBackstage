...
$(document).ready(function(){
	...
	$("#mod").click(function(){
		$("#form1").attr("action","{:url('admin/brand/mod')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;商品管理&nbsp;>&nbsp;编辑品牌</div>
	
	<div class="add-box">
		<ul>
			<li><div class="title">品牌名称</div><div class="input-box"><input name="name" type="text" class="input" value="{$data.name}"/></div><div class="tip">*</div><div class="clear"></div></li>
			<li id="catelist-box">
			...
			<li class="textarea" style="height:200px"><div class="title">品牌简介</div><div class="textarea-box" ><textarea name="description" id="description" cols="80" rows="5" style="width:800px;height:170px;font-size:14px;line-height:20px;">{$data.description}</textarea></div><div class="clear"></div></li>
			<li><div class="title">品牌排序</div><div class="input-box"><input name="sort" type="text" class="input" value="{$data.sort}"/></div><div class="tip">*</div><div class="clear"></div></li>
