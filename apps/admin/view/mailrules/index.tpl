...
$(document).ready(function(){
	...
	$(".notice").click(function(){
		...
		var url="{:url('admin/mailrules/changeNotice')}";
		var id=$(this).attr("id");
		var obj=$(this);
	...
	$("#set").click(function(){
		$("#form1").attr("action","{:url('admin/mailrules/batchSet')}");
		$("#form1").submit();
	})
...
<div class="main" id="main">
	<div class="position link grey_l"><a href="{:url('admin/index/index')}" target="_top">首页</a>&nbsp;>&nbsp;系统管理&nbsp;>&nbsp;邮件规则</div>
	<div class="tab-box">
		<ul>
